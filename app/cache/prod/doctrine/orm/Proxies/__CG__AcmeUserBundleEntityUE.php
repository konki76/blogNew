 ...
 */
class UE extends \Acme\UserBundle\Entity\UE implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'id', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'title', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'publishedAt', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'ues', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'slug', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'startContent', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'endContent', '' . "\0" . 'Acme\\UserBundle\\Entity\\UE' . "\0" . 'grps');
        }
