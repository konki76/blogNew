 ...
 */
class UserSkill extends \Acme\UserBundle\Entity\UserSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'id', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'value', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'title', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'publishedAt', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'skills', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'skill', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'users', '' . "\0" . 'Acme\\UserBundle\\Entity\\UserSkill' . "\0" . 'user');
        }
