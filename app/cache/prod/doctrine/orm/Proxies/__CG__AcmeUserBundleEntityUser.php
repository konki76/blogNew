...
class User extends \Acme\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Acme\\UserBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'Acme\\UserBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'Acme\\UserBundle\\Entity\\User' . "\0" . 'skills', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
