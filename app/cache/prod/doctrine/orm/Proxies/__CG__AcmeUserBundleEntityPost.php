 ...
 */
class Post extends \Acme\UserBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'slug', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'summary', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'authorEmail', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'publishedAt', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'comments', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'posts', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'answers', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'labelAnswer1', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'labelAnswer2', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'labelAnswer3', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'labelAnswer4', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'labelAnswer5', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'answer1', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'answer2', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'answer3', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'answer4', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'answer5', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'commentAnswer1', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'commentAnswer2', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'commentAnswer3', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'commentAnswer4', '' . "\0" . 'Acme\\UserBundle\\Entity\\Post' . "\0" . 'commentAnswer5', 'pGrps');
        }
