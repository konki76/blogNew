...
/**
 * @ORM\Entity(repositoryClass="Acme\UserBundle\Repository\QcmRepository")
 *
 * Defines the properties of the Qcm entity to represent the blog Qcms.
...
class Qcm
{
    ...
    /**
     * @ORM\Column(type="string")
     * @Assert\NotBlank(message="Give your Qcm a summary!")
     */
    private $summary;
     ...
     * @Assert\Length(
     *     min = "10",
     *     minMessage = "Qcm content is too short ({{ limit }} characters minimum)"
     * )
     */
    private $content;
    ...
    /**
     * Is the given User the author of this Qcm?
     *
     * @param User $user
     *
     * @return bool
