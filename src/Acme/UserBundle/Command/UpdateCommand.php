...
//		$patterns[47]='/Ç/';	$replacements[47]='&Ccedil;';
        $patterns[48]='/È/';
        $replacements[48]='&Egrave;';
        $patterns[49]='/É/';
        $replacements[49]='&Eacute;';
        $patterns[50]='/Ê/';
        $replacements[50]='&Ecirc;';
        $patterns[51]='/Ë/';
        $replacements[51]='&Euml;';
...
//		$patterns[57]='/Ñ/';	$replacements[57]='&Ntilde;';
    ...
    //	$patterns[59]='/Ó/';	$replacements[59]='&Oacute;';
        $patterns[60]='/Ô/';
        $replacements[60]='&Ocirc;';
//		$patterns[61]='/Õ/';	$replacements[61]='&Otilde;';
        $patterns[62]='/Ö/';
        $replacements[62]='&Ouml;';
    //	$patterns[63]='/×/';	$replacements[63]='&times;';
    //	$patterns[64]='/Ø/';	$replacements[64]='&Oslash;';
        $patterns[65]='/Ù/';
        $replacements[65]='&Ugrave;';
        $patterns[66]='/Ú/';
        $replacements[66]='&Uacute;';
        $patterns[67]='/Û/';
        $replacements[67]='&Ucirc;';
        $patterns[68]='/Ü/';
        $replacements[68]='&Uuml;';
        $patterns[69]='/Ý/';
        $replacements[69]='&Yacute;';
    //	$patterns[70]='/Þ/';	$replacements[70]='&thorn;';
    //	$patterns[71]='/ß/';	$replacements[71]='&szlig;';
        $patterns[72]='/à/';
        $replacements[72]='&agrave;';
        $patterns[73]='/á/';
        $replacements[73]='&aacute;';
    //	$patterns[74]='/â/';	$replacements[74]='&acirc;';
//		$patterns[75]='/ã/';	$replacements[75]='&atilde;';
        $patterns[76]='/ä/';
        $replacements[76]='&auml;';
    //	$patterns[77]='/å/';	$replacements[77]='&aring;';
        $patterns[78]='/æ/';
        $replacements[78]='&aelig;';
        $patterns[79]='/ç/';
        $replacements[79]='&ccedil;';
        $patterns[80]='/è/';
        $replacements[80]='&egrave;';
        $patterns[81]='/é/';
        $replacements[81]='&eacute;';
        $patterns[82]='/ê/';
        $replacements[82]='&ecirc;';
        $patterns[83]='/ë/';
        $replacements[83]='&euml;';
        $patterns[84]='/ì/';
        $replacements[84]='&igrave;';
        $patterns[85]='/í/';
        $replacements[85]='&iacute;';
        $patterns[86]='/î/';
        $replacements[86]='&icirc;';
        $patterns[87]='/ï/';
        $replacements[87]='&iuml;';
...
//		$patterns[89]='/ñ/';	$replacements[89]='&ntilde;';
    ...
    //	$patterns[91]='/ó/';	$replacements[91]='&oacute;';
        $patterns[92]='/ô/';
        $replacements[92]='&ocirc;';
//		$patterns[93]='/õ/';	$replacements[93]='&otilde;';
        $patterns[94]='/ö/';
        $replacements[94]='&ouml;';
    //	$patterns[95]='/÷/';	$replacements[95]='&divide;';
    //	$patterns[96]='/ø/';	$replacements[96]='&oslash;';
        $patterns[97]='/ù/';
        $replacements[97]='&ugrave;';
        $patterns[98]='/ú/';
        $replacements[98]='&uacute;';
        $patterns[99]='/û/';
        $replacements[99]='&ucirc;';
        $patterns[100]='/ü/';
        $replacements[100]='&uuml;';
    ...
    //	$patterns[103]='/ÿ/';	$replacements[103]='&yuml;';
        ...
        while ($file = readdir($dir)) {
            if ($file != '.' && $file != '..' && !is_dir($dirname.$file)) {
                ...
                //récupere le nom du fichier sans l'extension
                $iOLastSlash = last_index_of("/", $fileName);
                $fileLengh = strlen($fileName);
                $justName = substr($fileName, -($fileLengh-$iOLastSlash));
                //$output->writeln('<comment>Start $fileName['.$fileName.'] $justName['.$justName.'] iOLastSlash['.$iOLastSlash.']: ' . $now->format('d-m-Y G:i:s') . ' ---</comment>');
                $iOextension = last_index_of(".", $justName);
                $fileLengh = strlen($justName);
                $justName = substr($justName, 0, $iOextension-1);
                $output->writeln('<comment>Start $fileLengh['.$fileLengh.'] $justName['.$justName.'] iOextension['.$iOextension.']: ' . $now->format('d-m-Y G:i:s') . ' ---</comment>');
            
                $text2=fopen($fileName, 'w+') or die("Fichier manquant");
                
                if ($name == 'Post') {
                    $contenuMod = "labelAnswer|title|slug|answer|commentAnswer|summary|content|authorEmail|||\n".$contenuMod;
                }
